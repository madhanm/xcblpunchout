...
public class TaxDetail {
    ...
    protected MoneyElement taxableAmount;
    @XmlElement(name = "TaxAmount", required = true)
    protected MoneyElement taxAmount;
     ...
     *     
     */
    public MoneyElement getTaxableAmount() {
     ...
     *     
     */
    public void setTaxableAmount(MoneyElement value) {
     ...
     *     
     */
    public MoneyElement getTaxAmount() {
        return taxAmount;
    }
     ...
     *     
     */
    public void setTaxAmount(MoneyElement value) {
